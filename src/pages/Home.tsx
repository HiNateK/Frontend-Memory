    ...
    <div className="max-w-3xl mx-auto bg-white/5 rounded-2xl p-8 md:p-12 border border-white/10">
      <div className="text-center space-y-6">
        ...
        <p className="text-xl text-purple-100">
          Test2 Join our newsletter for helpful tips on preserving family memories
        </p>
        <form onSubmit={handleSubscribe} className="flex flex-col gap-4">
          <div className="flex flex-col md:flex-row gap-4 justify-center max-w-xl mx-auto">
            <input
              ...
              className="px-6 py-3 rounded-xl border border-white/20 focus:outline-none focus:border-white/40 w-full"
              required
            ...
            <button 
              type="submit"
              disabled={isSubmitting}
              className="hover:bg-white/20 text-white px-8 py-3 rounded-xl font-semibold transition-all hover:scale-105 whitespace-nowrap border border-white/10 disabled:opacity-50 disabled:hover:scale-100 flex items-center justify-center gap-2"
            >

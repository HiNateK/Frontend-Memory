/*
  ...
  2. Security
    ...
    - Add policies for public access to create sessions and messages
    - Add policies for viewing own messages and sessions
*/
...
DO $$ BEGIN
  ...
  DROP POLICY IF EXISTS "Users can view messages from their sessions" ON live_chat_messages;
EXCEPTION
